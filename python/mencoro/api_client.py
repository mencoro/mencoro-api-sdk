...
from mencoro.configuration import Configuration
from mencoro.api_response import ApiResponse, T as ApiResponseT
import mencoro.models
from mencoro import rest
from mencoro.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'mencoro-python/1.0.1'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mencoro.models, klass)
