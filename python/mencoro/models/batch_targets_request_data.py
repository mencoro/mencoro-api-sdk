...
class BatchTargetsRequestData(BaseModel):
    """
    The resources a batch operation acts on
    """ # noqa: E501
    ids: Annotated[List[UUID], Field(min_length=1, max_length=100)] = Field(description="Ids of the resources to act on. Duplicates are collapsed.")
