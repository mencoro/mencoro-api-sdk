...
class ListAiResponses200Response(BaseModel):
    """
    ListAiResponses200Response
    """ # noqa: E501
    items: Optional[List[AiResponseResource]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [AiResponseResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
