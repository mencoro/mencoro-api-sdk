...
class BatchChangeTrackedQueryCheckFrequencyRequestData(BaseModel):
    """
    ...
    check_frequency: StrictStr = Field(description="How often each query is checked while it is active.", alias="checkFrequency")
    __properties: ClassVar[List[str]] = ["ids", "checkFrequency"]
