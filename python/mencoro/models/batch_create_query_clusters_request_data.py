...
class BatchCreateQueryClustersRequestData(BaseModel):
    """
    The cluster names a batch create asks for
    """ # noqa: E501
    names: Annotated[List[Annotated[str, Field(strict=True, max_length=200)]], Field(min_length=1, max_length=100)] = Field(description="Cluster names to create, already trimmed and lower-cased on the server. Duplicates are collapsed.")
