...
class ListCompetitors200Response(BaseModel):
    """
    ListCompetitors200Response
    """ # noqa: E501
    items: Optional[List[CompetitorResource]] = None
    total: Optional[StrictInt] = Field(default=None, description="Number of competitors configured on the project")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CompetitorResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
