...
class GetMentionSamples400ResponseDetailsValueInner(BaseModel):
    """
    GetMentionSamples400ResponseDetailsValueInner
    """ # noqa: E501
    code: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    parameters: Optional[List[StrictStr]] = Field(default=None, description="Placeholder values behind the message. Always empty on this API: no rule it enforces carries any.")
    __properties: ClassVar[List[str]] = ["code", "message", "parameters"]
