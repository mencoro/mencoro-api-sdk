...
class ListQueryClusters200Response(BaseModel):
    """
    ListQueryClusters200Response
    """ # noqa: E501
    items: Optional[List[QueryClusterResource]] = None
    total: Optional[StrictInt] = Field(default=None, description="Clusters in the project, not the size of this page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [QueryClusterResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
