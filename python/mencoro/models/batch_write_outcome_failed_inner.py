...
class BatchWriteOutcomeFailedInner(BaseModel):
    """
    BatchWriteOutcomeFailedInner
    """ # noqa: E501
    id: Optional[UUID] = None
    error_code: Optional[StrictStr] = Field(default=None, description="The same code a single-item call returns for this problem.", alias="errorCode")
