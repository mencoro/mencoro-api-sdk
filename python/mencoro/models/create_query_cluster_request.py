...
class CreateQueryClusterRequest(BaseModel):
    """
    CreateQueryClusterRequest
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(default=None, description="Stored trimmed and lower-cased. Unique within the project.")
