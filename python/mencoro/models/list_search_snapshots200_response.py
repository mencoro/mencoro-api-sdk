...
class ListSearchSnapshots200Response(BaseModel):
    """
    ListSearchSnapshots200Response
    """ # noqa: E501
    items: Optional[List[SearchSnapshotResource]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [SearchSnapshotResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
