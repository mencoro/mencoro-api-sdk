...
class GetMeStats200ResponseOrganizations(BaseModel):
    """
    GetMeStats200ResponseOrganizations
    """ # noqa: E501
    total: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Organizations the caller is an active member of, within the key's scope.", json_schema_extra={"examples": [3]})
