...
class ChangeTrackedQueryCheckFrequencyRequestData(BaseModel):
    """
    How often a tracked query is checked
    """ # noqa: E501
    check_frequency: StrictStr = Field(description="How often the query is checked while it is active.", alias="checkFrequency")
    __properties: ClassVar[List[str]] = ["checkFrequency"]
