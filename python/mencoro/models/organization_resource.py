...
class OrganizationResource(BaseModel):
    ...
    role: StrictStr = Field(description="The caller's current role in this organization")
    created_at: datetime = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "status", "imageUrl", "contactEmail", "role", "createdAt"]
