...
class ListShoppingSnapshots200Response(BaseModel):
    """
    ListShoppingSnapshots200Response
    """ # noqa: E501
    items: Optional[List[ShoppingSnapshotResource]] = None
    total: Optional[StrictInt] = Field(default=None, description="Captures matching the filter, not the size of this page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ShoppingSnapshotResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
