...
class ChangeTrackedQueryPassesRequestData(BaseModel):
    """
    How many passes a tracked query runs per check
    """ # noqa: E501
    n_passes: Annotated[int, Field(le=10, strict=True, ge=1)] = Field(description="Passes run per check. Only an AI engine accepts more than one.", alias="nPasses")
    __properties: ClassVar[List[str]] = ["nPasses"]
