...
class CompetitorCoOccurrenceResponse(BaseModel):
    """
    CompetitorCoOccurrenceResponse
    """ # noqa: E501
    competitors: List[CompetitorCoOccurrenceRow]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "competitors": [CompetitorCoOccurrenceRow.from_dict(_item) for _item in obj["competitors"]] if obj.get("competitors") is not None else None
        })
        return _obj
