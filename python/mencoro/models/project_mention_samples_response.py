...
class ProjectMentionSamplesResponse(BaseModel):
    """
    ProjectMentionSamplesResponse
    """ # noqa: E501
    samples: List[MentionSampleResponse]
    total: StrictInt
    __properties: ClassVar[List[str]] = ["samples", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "samples": [MentionSampleResponse.from_dict(_item) for _item in obj["samples"]] if obj.get("samples") is not None else None,
            "total": obj.get("total")
        })
        return _obj
