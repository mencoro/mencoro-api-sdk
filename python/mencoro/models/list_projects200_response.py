...
class ListProjects200Response(BaseModel):
    ...
    """ # noqa: E501
    items: Optional[List[ProjectResource]] = None
    total: Optional[StrictInt] = Field(default=None, description="Every project matching the filters, not the size of this page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ProjectResource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total")
        })
        return _obj
