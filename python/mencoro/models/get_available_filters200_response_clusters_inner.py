...
class GetAvailableFilters200ResponseClustersInner(BaseModel):
    """
    GetAvailableFilters200ResponseClustersInner
    """ # noqa: E501
    id: Optional[UUID] = Field(default=None, description="Pass this in queryClusterIds, never the name")
