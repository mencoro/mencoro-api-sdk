...
with mencoro.ApiClient(configuration) as api_client:
    ...
    job_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Must be a clustering job started for this organization and project.
    idempotency_key = 'idempotency_key_example' # str | Repeat it to retry a lost response without applying the job twice.

    try:
        # Apply the result of a clustering job
        api_response = api_instance.apply_clustering_job(organization_id, project_id, job_id, idempotency_key)
        print("The response of ClustersApi->apply_clustering_job:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClustersApi->apply_clustering_job: %s\n" % e)
```
 ...
 **project_id** | **UUID**|  | 
 **job_id** | **UUID**| Must be a clustering job started for this organization and project. | 
 **idempotency_key** | **str**| Repeat it to retry a lost response without applying the job twice. | 
...
with mencoro.ApiClient(configuration) as api_client:
    ...
    organization_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | 
    project_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | 
    idempotency_key = 'idempotency_key_example' # str | Repeat it to retry a lost response without creating the batch twice.
    batch_create_query_clusters_request_data = mencoro.BatchCreateQueryClustersRequestData() # BatchCreateQueryClustersRequestData | 

    try:
        # Create several keyword clusters at once
        api_response = api_instance.batch_create_query_clusters(organization_id, project_id, idempotency_key, batch_create_query_clusters_request_data)
        print("The response of ClustersApi->batch_create_query_clusters:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClustersApi->batch_create_query_clusters: %s\n" % e)
```
 ...
 **organization_id** | **UUID**|  | 
 **project_id** | **UUID**|  | 
 **idempotency_key** | **str**| Repeat it to retry a lost response without creating the batch twice. | 
...
with mencoro.ApiClient(configuration) as api_client:
    ...
    organization_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | 
    project_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | 
    idempotency_key = '3f9d2c18-6b4a-4c77-9f10-6f2d5a7c8e21' # str | A token you choose per operation, 8 to 255 printable ASCII characters with no spaces; a UUID is the obvious choice. Repeat it to retry a lost response without creating a second cluster. The key is scoped to your API key, and it is bound to the method, the path and the body of the first attempt: repeating it with anything else changed is refused with 409 rather than replayed.
    create_query_cluster_request = {"name":"Agencia SEO"} # CreateQueryClusterRequest | 

    try:
        # Create a keyword cluster
        api_response = api_instance.create_query_cluster(organization_id, project_id, idempotency_key, create_query_cluster_request)
        print("The response of ClustersApi->create_query_cluster:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClustersApi->create_query_cluster: %s\n" % e)
```
 ...
 **organization_id** | **UUID**|  | 
 **project_id** | **UUID**|  | 
 **idempotency_key** | **str**| A token you choose per operation, 8 to 255 printable ASCII characters with no spaces; a UUID is the obvious choice. Repeat it to retry a lost response without creating a second cluster. The key is scoped to your API key, and it is bound to the method, the path and the body of the first attempt: repeating it with anything else changed is refused with 409 rather than replayed. | 
...
with mencoro.ApiClient(configuration) as api_client:
    ...
    idempotency_key = 'idempotency_key_example' # str | Repeat it to retry a lost response; a fresh key answers 404 once the cluster is gone.

    try:
        # Delete a keyword cluster
        api_response = api_instance.delete_query_cluster(organization_id, project_id, cluster_id, idempotency_key)
        print("The response of ClustersApi->delete_query_cluster:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClustersApi->delete_query_cluster: %s\n" % e)
```
 ...
 **idempotency_key** | **str**| Repeat it to retry a lost response; a fresh key answers 404 once the cluster is gone. | 
...
with mencoro.ApiClient(configuration) as api_client:
    ...
    project_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | 
    cluster_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | Must be a cluster of the project in the path.
    idempotency_key = 'idempotency_key_example' # str | Repeat it to retry a lost response without renaming twice.
    create_query_cluster_request = mencoro.CreateQueryClusterRequest() # CreateQueryClusterRequest | 

    try:
        # Rename a keyword cluster
        api_response = api_instance.rename_query_cluster(organization_id, project_id, cluster_id, idempotency_key, create_query_cluster_request)
        print("The response of ClustersApi->rename_query_cluster:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClustersApi->rename_query_cluster: %s\n" % e)
```
 ...
 **project_id** | **UUID**|  | 
 **cluster_id** | **UUID**| Must be a cluster of the project in the path. | 
 **idempotency_key** | **str**| Repeat it to retry a lost response without renaming twice. | 
 **create_query_cluster_request** | [**CreateQueryClusterRequest**](CreateQueryClusterRequest.md)|  | 
...
with mencoro.ApiClient(configuration) as api_client:
    ...
    organization_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | 
    project_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | 
    idempotency_key = 'idempotency_key_example' # str | Repeat it to retry a lost response without starting a second job.
    start_clustering_job_request_data = mencoro.StartClusteringJobRequestData() # StartClusteringJobRequestData | 

    try:
        # Start a keyword clustering job
        api_response = api_instance.start_clustering_job(organization_id, project_id, idempotency_key, start_clustering_job_request_data)
        print("The response of ClustersApi->start_clustering_job:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ClustersApi->start_clustering_job: %s\n" % e)
```
 ...
 **organization_id** | **UUID**|  | 
 **project_id** | **UUID**|  | 
 **idempotency_key** | **str**| Repeat it to retry a lost response without starting a second job. | 
