...
```typescript
import type { PreviewOrganizationOperation200ResponseOrganization } from '@mencoro/api'

// TODO: Update the object below with actual values
const example = {
  "id": null,
  "name": null,
} satisfies PreviewOrganizationOperation200ResponseOrganization
...
const exampleParsed = JSON.parse(exampleJSON) as PreviewOrganizationOperation200ResponseOrganization
