...
```typescript
import type { BatchPauseTrackedQueries200Response } from '@mencoro/api'

// TODO: Update the object below with actual values
const example = {
  "successful": null,
  "failed": null,
} satisfies BatchPauseTrackedQueries200Response
...
const exampleParsed = JSON.parse(exampleJSON) as BatchPauseTrackedQueries200Response
