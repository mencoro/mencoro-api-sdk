...
```typescript
import type { BulkAddClustersToTrackedQueries200Response } from '@mencoro/api'

// TODO: Update the object below with actual values
const example = {
  "successful": null,
  "failed": null,
} satisfies BulkAddClustersToTrackedQueries200Response
...
const exampleParsed = JSON.parse(exampleJSON) as BulkAddClustersToTrackedQueries200Response
