...
```typescript
import type { BatchResumeTrackedQueries200Response } from '@mencoro/api'

// TODO: Update the object below with actual values
const example = {
  "successful": null,
  "failed": null,
} satisfies BatchResumeTrackedQueries200Response
...
const exampleParsed = JSON.parse(exampleJSON) as BatchResumeTrackedQueries200Response
