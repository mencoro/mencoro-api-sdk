...
public class Example {
  public static void main(String[] args) {
    ...
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation, so a lost response can be retried without repeating the write.
    ClusterMembershipRequestData clusterMembershipRequestData = new ClusterMembershipRequestData(); // ClusterMembershipRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#addClustersToTrackedQuery");
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation. Replaying it returns the first answer instead of applying anything again.
    BatchChangeTrackedQueryCheckFrequencyRequestData batchChangeTrackedQueryCheckFrequencyRequestData = new BatchChangeTrackedQueryCheckFrequencyRequestData(); // BatchChangeTrackedQueryCheckFrequencyRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#batchChangeTrackedQueriesCheckFrequency");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation. Replaying it returns the first answer instead of applying anything again.
    BatchChangeTrackedQueryPassesRequestData batchChangeTrackedQueryPassesRequestData = new BatchChangeTrackedQueryPassesRequestData(); // BatchChangeTrackedQueryPassesRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#batchChangeTrackedQueriesNPasses");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation. Replaying it returns the first answer instead of creating anything again.
    BatchCreateTrackedQueriesRequestData batchCreateTrackedQueriesRequestData = new BatchCreateTrackedQueriesRequestData(); // BatchCreateTrackedQueriesRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#batchCreateTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | Repeating a request with the same key and the same ids answers with the first attempt's result instead of submitting again.
    BatchTargetsRequestData batchTargetsRequestData = new BatchTargetsRequestData(); // BatchTargetsRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#batchForceCheckTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | Repeating a request with the same key and the same ids answers with the first attempt's result.
    BatchTargetsRequestData batchTargetsRequestData = new BatchTargetsRequestData(); // BatchTargetsRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#batchPauseTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#batchResumeTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation, so a lost response can be retried without repeating the batch.
    BulkAddClustersToTrackedQueriesRequest bulkAddClustersToTrackedQueriesRequest = new BulkAddClustersToTrackedQueriesRequest(); // BulkAddClustersToTrackedQueriesRequest | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#bulkAddClustersToTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation. Replaying it returns the first answer instead of deleting anything again.
    BatchTargetsRequestData batchTargetsRequestData = new BatchTargetsRequestData(); // BatchTargetsRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#bulkDeleteTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation, so a lost response can be retried without repeating the batch.
    BulkRemoveClustersFromTrackedQueriesRequest bulkRemoveClustersFromTrackedQueriesRequest = new BulkRemoveClustersFromTrackedQueriesRequest(); // BulkRemoveClustersFromTrackedQueriesRequest | Required. A DELETE with no body is rejected.
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#bulkRemoveClustersFromTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID trackedQueryId = UUID.randomUUID(); // UUID | Must belong to the project in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation. Replaying it returns the first answer instead of applying anything again.
    ChangeTrackedQueryCheckFrequencyRequestData changeTrackedQueryCheckFrequencyRequestData = new ChangeTrackedQueryCheckFrequencyRequestData(); // ChangeTrackedQueryCheckFrequencyRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#changeTrackedQueryCheckFrequency");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID trackedQueryId = UUID.randomUUID(); // UUID | Must belong to the project in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation. Replaying it returns the first answer instead of applying anything again.
    ChangeTrackedQueryPassesRequestData changeTrackedQueryPassesRequestData = new ChangeTrackedQueryPassesRequestData(); // ChangeTrackedQueryPassesRequestData | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#changeTrackedQueryNPasses");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String status = "active"; // String | Restrict both numbers to one status. Lower-case; an unknown value is rejected, not ignored. Omitted, every status is counted and priced.
    try {
      TrackedQueryCountResource result = apiInstance.countTrackedQueries(organizationId, projectId, status);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TrackedQueriesApi#countTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **organizationId** | **UUID**|  | |
| **projectId** | **UUID**|  | |
| **status** | **String**| Restrict both numbers to one status. Lower-case; an unknown value is rejected, not ignored. Omitted, every status is counted and priced. | [optional] [enum: active, paused] |
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | Repeating a request with the same key answers with the first attempt's result instead of submitting a second wave.
    try {
      SubmittedChecksResource result = apiInstance.forceCheckAllActiveTrackedQueries(organizationId, projectId, idempotencyKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TrackedQueriesApi#forceCheckAllActiveTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#getTrackedQuery");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | 
    UUID trackedQueryId = UUID.randomUUID(); // UUID | Must belong to the project in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | Repeating a request with the same key answers with the first attempt's result instead of pausing again.
    try {
      TrackedQueryDetailResource result = apiInstance.pauseTrackedQuery(organizationId, projectId, trackedQueryId, idempotencyKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TrackedQueriesApi#pauseTrackedQuery");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID trackedQueryId = UUID.randomUUID(); // UUID | Must belong to the project in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per operation, so a lost response can be retried without repeating the write.
    ClusterMembershipRequestData clusterMembershipRequestData = new ClusterMembershipRequestData(); // ClusterMembershipRequestData | Required. A DELETE with no body is rejected.
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#removeClustersFromTrackedQuery");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | 
    UUID trackedQueryId = UUID.randomUUID(); // UUID | Must belong to the project in the path.
    UUID aiResponseId = UUID.randomUUID(); // UUID | A capture id from the AI responses listing. Must belong to the tracked query in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | A client-chosen key, unique per report, so a lost response can be retried without filing the report twice.
    ReportAiResponseRequest reportAiResponseRequest = new ReportAiResponseRequest(); // ReportAiResponseRequest | 
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#reportAiResponse");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **projectId** | **UUID**|  | |
| **trackedQueryId** | **UUID**| Must belong to the project in the path. | |
| **aiResponseId** | **UUID**| A capture id from the AI responses listing. Must belong to the tracked query in the path. | |
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | 
    UUID trackedQueryId = UUID.randomUUID(); // UUID | Must belong to the project in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | Repeating a request with the same key answers with the first attempt's result instead of resuming again.
    try {
      TrackedQueryDetailResource result = apiInstance.resumeTrackedQuery(organizationId, projectId, trackedQueryId, idempotencyKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TrackedQueriesApi#resumeTrackedQuery");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String search = "search_example"; // String | Free-text search over the keyword.
    ...
    String sortBy = "queryText"; // String | 
    ...
    try {
      ...
      System.err.println("Exception when calling TrackedQueriesApi#searchTrackedQueries");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **status** | **String**|  | [optional] [enum: active, paused] |
...
| **sortBy** | **String**|  | [optional] [default to queryText] [enum: queryText, lastSerpPosition, lastMentionPosition, lastShoppingPosition, lastShareOfVoice, lastPositivityIndex, lastMentionCount, lastCheckedAt] |
