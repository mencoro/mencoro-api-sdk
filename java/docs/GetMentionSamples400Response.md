...
|**requestId** | **UUID** | Correlation id, also returned in the X-Request-Id header. |  |
|**details** | **Map&lt;String, List&lt;GetMentionSamples400ResponseDetailsValueInner&gt;&gt;** | Present only on a validation failure: one entry per rejected field, each an array of errors. |  [optional] |
