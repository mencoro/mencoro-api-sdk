...
public class Example {
  public static void main(String[] args) {
    ...
    UUID jobId = UUID.randomUUID(); // UUID | Must be a clustering job started for this organization and project.
    String idempotencyKey = "idempotencyKey_example"; // String | Repeat it to retry a lost response without applying the job twice.
    try {
      ApplyClusteringJobOutcome result = apiInstance.applyClusteringJob(organizationId, projectId, jobId, idempotencyKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ClustersApi#applyClusteringJob");
...
| **organizationId** | **UUID**|  | |
| **projectId** | **UUID**|  | |
| **jobId** | **UUID**| Must be a clustering job started for this organization and project. | |
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | Repeat it to retry a lost response without creating the batch twice.
    BatchCreateQueryClustersRequestData batchCreateQueryClustersRequestData = new BatchCreateQueryClustersRequestData(); // BatchCreateQueryClustersRequestData | 
    try {
      ...
      System.err.println("Exception when calling ClustersApi#batchCreateQueryClusters");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ClustersApi#createQueryCluster");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String idempotencyKey = "idempotencyKey_example"; // String | Repeat it to retry a lost response; a fresh key answers 404 once the cluster is gone.
    try {
      DeleteQueryCluster200Response result = apiInstance.deleteQueryCluster(organizationId, projectId, clusterId, idempotencyKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ClustersApi#deleteQueryCluster");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | 
    UUID clusterId = UUID.randomUUID(); // UUID | Must be a cluster of the project in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | Repeat it to retry a lost response without renaming twice.
    CreateQueryClusterRequest createQueryClusterRequest = new CreateQueryClusterRequest(); // CreateQueryClusterRequest | 
    try {
      ...
      System.err.println("Exception when calling ClustersApi#renameQueryCluster");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    UUID projectId = UUID.randomUUID(); // UUID | 
    String idempotencyKey = "idempotencyKey_example"; // String | Repeat it to retry a lost response without starting a second job.
    StartClusteringJobRequestData startClusteringJobRequestData = new StartClusteringJobRequestData(); // StartClusteringJobRequestData | 
    try {
      ...
      System.err.println("Exception when calling ClustersApi#startClusteringJob");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
