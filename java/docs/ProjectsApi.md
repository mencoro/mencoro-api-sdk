...
public class Example {
  public static void main(String[] args) {
    ...
    String idempotencyKey = "idempotencyKey_example"; // String | Unique per attempt. Without it a lost response cannot be retried without risking a second competitor.
    ...
    try {
      ...
      System.err.println("Exception when calling ProjectsApi#createCompetitor");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    String idempotencyKey = "idempotencyKey_example"; // String | Unique per attempt. A retry carrying the same key is answered from the record instead of running again.
    try {
      CompetitorResource result = apiInstance.deleteCompetitor(organizationId, projectId, competitorId, idempotencyKey);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#deleteCompetitor");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ProjectsApi#getBrandProfile");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer offset = 0; // Integer | Number of competitors to skip before the page starts.
    String sortOrder = "asc"; // String | Direction of the id ordering. An unknown value is rejected, not replaced by the default.
    try {
      ListCompetitors200Response result = apiInstance.listCompetitors(organizationId, projectId, limit, offset, sortOrder);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#listCompetitors");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **sortOrder** | **String**| Direction of the id ordering. An unknown value is rejected, not replaced by the default. | [optional] [default to asc] [enum: asc, desc] |
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID organizationId = UUID.randomUUID(); // UUID | 
    Integer limit = 20; // Integer | Page size. A larger value is rejected, never silently reduced.
    Integer offset = 0; // Integer | Rows to skip before the page starts. Page by advancing it in steps of `limit` until it reaches `total`.
...
| **sortBy** | **String**|  | [optional] [default to createdAt] [enum: createdAt, name, trackedQueryCount, avgSerpPosition, avgShoppingPosition, avgMentionPosition, avgLinkPosition, mentionRate, serpRate, shoppingRate, positivityIndex, shareOfVoice, serpPositionStability, shoppingPositionStability, lastRankDetectedAt] |
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | 
    Integer limit = 20; // Integer | Page size. A larger value is rejected, never silently reduced.
    Integer offset = 0; // Integer | Number of clusters to skip before the page starts.
    String sortOrder = "asc"; // String | Direction of the name ordering. An unknown value is rejected, not replaced by the default.
    try {
      ListQueryClusters200Response result = apiInstance.listQueryClusters(organizationId, projectId, limit, offset, sortOrder);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ProjectsApi#listQueryClusters");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **sortOrder** | **String**| Direction of the name ordering. An unknown value is rejected, not replaced by the default. | [optional] [default to asc] [enum: asc, desc] |
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | Must belong to the organization in the path.
    UUID competitorId = UUID.randomUUID(); // UUID | Must belong to the project in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | Unique per attempt. A retry carrying the same key and the same body is answered from the record instead of running again.
    CreateCompetitorRequest createCompetitorRequest = new CreateCompetitorRequest(); // CreateCompetitorRequest | 
    try {
      ...
      System.err.println("Exception when calling ProjectsApi#updateCompetitor");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID projectId = UUID.randomUUID(); // UUID | Must belong to the organization in the path.
    String idempotencyKey = "idempotencyKey_example"; // String | Unique per attempt. A retry carrying the same key and the same body is answered from the record instead of running again.
    UpdateProjectBrandProfileRequest updateProjectBrandProfileRequest = new UpdateProjectBrandProfileRequest(); // UpdateProjectBrandProfileRequest | 
    try {
      ...
      System.err.println("Exception when calling ProjectsApi#updateProjectBrandProfile");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
