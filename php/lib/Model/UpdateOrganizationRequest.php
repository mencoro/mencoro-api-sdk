...
class UpdateOrganizationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateOrganizationRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateOrganizationRequest., must be bigger than or equal to 3.');
        }
